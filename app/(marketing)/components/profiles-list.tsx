        ...
        >
            <div className="mx-auto flex align-center max-w-[58rem] flex-col items-center space-y-4 text-center">
                ...
                <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                    New DevOps engineers looking for jobs in the tech industry. 
                </p>
            </div>
            <div className="mx-auto justinfy-center md:max-w-[64rem]">
                <TeamMembers />
            </div>
            <div className="hidden mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
